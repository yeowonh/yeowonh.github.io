...
export const experience: ExperienceItem[] = [
  {
    ...
    highlights: [
      '테이블 리니지와 비즈니스 온톨로지를 연결한 사내 데이터 카탈로그를 출시하고 MCP를 통해 AI 개발 업무까지 확장했습니다. **151 MAU와 Web, MCP, Slack 합산 6.09만 건의 요청**을 기록했고, 평균 응답 시간은 **21.5초에서 4.0초로 81% 단축**했습니다.',
      '**제품 품질 체계를 구축했습니다**. 일별 사용 현황 리포트, 카탈로그 정확도 골든 평가 세트, 주간 정합성 점검, 모든 세션에 대한 LLM 기반 스코어링과 정기 실패 리뷰를 운영했습니다.',
      '**피드백 루프를 닫았습니다**. 자동 후속 질문, 인앱 피드백, 격주 사용자 인터뷰를 통해 멀티턴 대화, 이미지 입력, 답변 재생성 및 편집, 비개발자용 인터페이스를 제품에 반영했습니다.',
  ...
  },
  {
    ...
    highlights: [
      ...
      '평가 데이터셋과 자동화된 품질 개선 루프를 구축하고 Hybrid Search, Text-to-SQL, Reranking을 결합해 베이스라인 대비 **검색 정확도 +140.3%, 답변 정확도 +83.4%**를 달성했습니다.',
