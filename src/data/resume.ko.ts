...
export const experience: ExperienceItem[] = [
  {
    ...
    summary:
      '비즈니스 조직이 데이터 전문가를 기다리지 않고 질문에 답할 수 있도록 셀프서비스 분석 시스템과 Applied AI 제품을 개발하고, 의사결정에 필요한 제품·성장 분석을 수행합니다.',
    highlights: [
      ...
      '**의사결정에 필요한 제품·성장 분석을 설계했습니다.** 신규 유입, 활성화, 재이용, 캠페인 효과를 구분할 수 있도록 코호트, 노출·기준 시점, 전환 윈도우, 비교 기준을 정의하고 이벤트 커버리지와 분모를 검증했습니다.',
