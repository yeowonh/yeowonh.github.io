...
export const experience: ExperienceItem[] = [
  {
    ...
    highlights: [
      ...
      '**사용자 피드백을 제품 개선으로 연결하는 주기를 만들었습니다**. 자동 후속 질문, 인앱 피드백, 격주 사용자 인터뷰를 통해 멀티턴 대화, 이미지 입력, 답변 재생성 및 편집, 비개발자용 인터페이스를 제품에 반영했습니다.',
  ...
  },
  {
    ...
    highlights: [
      ...
      '평가 데이터셋과 자동화된 평가 주기를 구축하고 Hybrid Search, Text-to-SQL, Reranking을 결합해 베이스라인 대비 검색·답변 정확도를 높였습니다.',
